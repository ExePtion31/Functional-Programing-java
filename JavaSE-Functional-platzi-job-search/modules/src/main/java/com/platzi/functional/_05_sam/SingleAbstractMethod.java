...
public class SingleAbstractMethod {
  ...
  /**
   * Se le considera SAM a una interface cuando tiene un unico metodo, sin valor definido. Por
   * ejemplo:
   */
...
//
  ...
  /**
   * Este concepto es importante empezando en Java 8 por varias razones, la principal es que el
   * compilador nos permitira usar una anotacion disponible UNICAMENTE para SAMs:
   * @FunctionalInterface
   */
  @FunctionalInterface
...
//
  ...
  /**
   * Con las interfaces anotadas, podemos usar la forma de lambdas/funciones para definir el
   * comportamiento
   */
